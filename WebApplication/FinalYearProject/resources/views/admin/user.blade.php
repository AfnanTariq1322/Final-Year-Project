                                        ...
                                        <tr id="userRow{{ $user->id }}">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form id="deleteForm{{ $user->id }}" action="{{ route('admin.delete', ['id' => $user->id]) }}" method="POST">
    @csrf
    @method('DELETE')
    <button type="submit" onclick="return confirm('Are you sure you want to delete this user?')" class="btn btn-danger shadow btn-xs sharp">
