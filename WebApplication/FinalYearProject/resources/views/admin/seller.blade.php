...
<tbody id="userTableBody">
    ...
    <tr>
        <td>
            @if($seller->picture)
                <img src="{{ asset('storage/' . $seller->picture) }}" alt="Profile Picture" width="40" height="40">
            @else
                <img src="{{ asset('path_to_default_image.jpg') }}" alt="Default Picture" width="40" height="40">
            @endif
        </td>
        <td>{{ $seller->name }}</td>
        <td>{{ $seller->email }}</td>
        <td class="badge badge-sm badge-secondary">{{ $seller->specialty }}</td>
        <td>{{ $seller->phone }}</td>
        <td>
        ...
        <td>
            <div class="d-flex">
                ...
                <form action="{{ route('toggle.seller.status', $seller->id) }}" method="POST" class="mr-2">
                    @csrf
                    @method('PATCH')
