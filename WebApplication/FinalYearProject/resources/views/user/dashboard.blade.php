            ...
            <div class="modal-content">
                ...
                <div class="offcanvas-logo">
                    <a href="https://createrdirect.corammerswork.com/"><img
                            src="img/CDA-Logo-01__2_-removebg-preview.png" alt="#"></a>
                </div>
                ...
                <nav id="offcanvas-menu" class="offcanvas-menu">
                    ...
                    <ul class="nav-menu menu navigation list-none">
                        ...
                        <li><a href="our-creator.html">Our Creators</a>
                            <!-- <ul class="sub-menu">
                            <li><a href="influencers.html">Creators List</a></li>
                        </ul> -->
                        </li>
                        ...
                        <div class="inflanar-header__inside">
                            <div class="inflanar-header__group">
                                <div class="inflanar-header__logo">
                                    <a href="https://createrdirect.corammerswork.com/">
                                        <img src="img/CDA-Logo-01__2_-removebg-preview.png" alt="#">
                                    </a>
                                </div>
                                <div class="inflanar-header__menu">
                                    <div class="navbar">
                                        <div class="nav-item">
                                            <ul class="nav-menu menu navigation list-none">
                                                <li class="active"><a
                                                        href="https://createrdirect.corammerswork.com/">Home</a></li>
                                                <li><a href="about.html">About</a></li>
                                                <li><a href="our-creator.html">Our Creators</a></li>
                                                <li><a href="pricing.html">Pricing</a></li>
                                                <li><a href="contact.html">Contact Us</a></li>
                                            </ul>
                                        </div>
                            ...
                            <div class="inflanar-header__button">
                                ...
                                <a href="{{ route('user.dashboard') }}"
                                    class="inflanar-btn inflanar-btn--header">Dashboard</a>
                                @else
    ...
    <div class="modal-dialog modal-dialog-centered inflanar-preview__logout">
        <div class="modal-content">
            <div class="modal-header inflanar__modal__header">
                ...
                <button type="button" class="inflanar-preview__modal--close btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="fas fa-remove"></i>
                </button>
            </div>
            <div class="modal-body inflanar-modal__body">
                <div class="inflanar-preview__close">
                    ...
                    <h2 class="inflanar-preview__close-title">Are you sure you want to Logout <span>Inflanar?</span></h2>
                    ...
                    <div class="inflanar__item-button--group">
                        <button class="inflanar-btn" type="button" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Yes Logout</button>
                    ...
                    <div class="col-lg-3 col-md-4 col-12 inflanar-personals__list mg-top-30">
                        <div class="inflanar-psidebar inflanar-default-bg">
                            ...
                            <div class="inflanar-psidebar__author">
                                ...
                                <h4 class="inflanar-psidebar__atitle">Martan Jhon <span>Admin</span></h4>
                            </div>

                            <div class="list-group inflanar-psidebar__list">
                                <a class="list-group-item active" href="dashboard.html">
                                ...
                                <a class="list-group-item " href="dashboard-accounts.html">
                                    <span class="inflanar-psidebar__icon">
                                    ...
                                    <span class="inflanar-psidebar__title">Accounts</span>
                                </a>
                                <a class="list-group-item " href="dasboard-user-brand.html">
                                    <span class="inflanar-psidebar__icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span class="inflanar-psidebar__title">Brand</span>
                                </a>
                                <a class="list-group-item" href="dashboard-user-influencer.html">
                                    <span class="inflanar-psidebar__icon">
                                    ...
                                    <span class="inflanar-psidebar__title">Influencer</span>
                                </a>
                                ...
                                <a class="list-group-item" href="#">
                                    ...
                                    <span class="inflanar-psidebar__title">Payments </span>
                                </a>
                                <!-- <a class="list-group-item" href="dashboard-password.html">
                                    <span class="inflanar-psidebar__icon">
                                        <svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span class="inflanar-psidebar__title">Account Setting </span>
                                </a> -->
                                <a class="list-group-item" href="dashboard-profile.html">
                                    <span class="inflanar-psidebar__icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span class="inflanar-psidebar__title">Account Settings</span>
                                </a>
                        ...
                        <div class="inflanar-profile-info mg-top-30">
                            ...
                            <ul class="inflanar-profile-info__list inflanar-dflex-column list-none">
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Name :</h4>
                                    <p class="inflanar-profile-info__text">Martan Jhon</p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Email :</h4>
                                    <p class="inflanar-profile-info__text"><a href="#" class="__cf_email__"
                                            data-cfemail="2f4b4a42404a424e46436f48424e4643014c4042">contact@yourmail.com</a>
                                    </p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Phone :</h4>
                                    <p class="inflanar-profile-info__text">+61 3 8376 6284</p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Country :</h4>
                                    <p class="inflanar-profile-info__text">Bangladesh</p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">City :</h4>
                                    <p class="inflanar-profile-info__text">Dhaka</p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Post Code :</h4>
                                    <p class="inflanar-profile-info__text">1207</p>
                                </li>
                                <li class="inflanar-dflex">
                                    <h4 class="inflanar-profile-info__title">Address :</h4>
                                    <p class="inflanar-profile-info__text">121 King Street, Melbourne</p>
                                </li>
                            </ul>
                        </div>
                    </div>
