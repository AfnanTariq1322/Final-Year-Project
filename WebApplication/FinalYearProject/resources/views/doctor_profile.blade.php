                        ...
                        <div class="profile-card">
                            ...
                            <div class="profile-content">
                                    ...
                                    <div class="bank-details-grid">
                                        ...
                                        @if(is_array($bankDetails) && count($bankDetails) > 0)
                                            @foreach($bankDetails as $bank)
                                                @if(is_array($bank) && isset($bank['bank_name']))
                                ...
                                <div class="map-section mt-4">
                                    <h5 class="section-title mb-3"><i class="fas fa-map-marker-alt"></i> Location</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="map" rows="4" placeholder="Paste your Google Maps iframe code here">{{ $doctor->map }}</textarea>
                                            <small class="text-muted">Copy the iframe code from Google Maps and paste it here</small>
                                        </div>
                                    </div>
