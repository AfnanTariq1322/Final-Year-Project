...
<head>
    ...
    <title>Fundus Disease Analysis - Doctor Register</title>
                        ...
                        <div class="inflanar-signin__logins">
                            <div class="inflanar-signin__header mg-btm-10">
                                <div class="inflanar-signin__heading">
                                    ...
                                    <br>
                                    <p class="inflanar-signin__tag">Doctor Registration</p>
                                    <h4 class="inflanar-signin__title3">Join Our Network of Eye Care Specialists</h4>
                                    <p class="inflanar-signin__subtitle">Register to provide expert care and analysis for your patients</p>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group inflanar-form-input mg-top-20">
                                                ...
                                                <input class="inflanar-signin__form-input" placeholder="Enter your password" id="password-field" type="password" name="password" required="required">
                                                @error('password')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group inflanar-form-input mg-top-20">
                                                ...
                                                <input class="inflanar-signin__form-input" placeholder="Confirm your password" id="confirm-password-field" type="password" name="confirm_password" required="required">
