                                                ...
                                                children: [
                                                  if (blog['image'] != null)
                                                    ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        'http://127.0.0.1:8000/storage/blogs/${blog['image']}',
                                                        height: 200,
                                                        width: double.infinity,
                                                        fit: BoxFit.cover,
                                                        loadingBuilder: (context, child, loadingProgress) {
                                                          if (loadingProgress == null) return child;
                                                          print('Loading blog image: http://127.0.0.1:8000/storage/blogs/${blog['image']}');
                                                        ...
                                                        errorBuilder: (context, error, stackTrace) {
                                                          ...
                                                          print('Attempted to load image from: http://127.0.0.1:8000/storage/blogs/${blog['image']}');
                                                          return Container(
                                                            height: 200,
                                                            color: Colors.grey[200],
                                                            child: Column(
                                                  ...
                                                  if (blog['disease'] != null && blog['disease']['image'] != null)
                                                    Container(
                                                      height: 200,
                                                      width: double.infinity,
                                                      decoration: BoxDecoration(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Text(
                                                                blog['disease']['name'] ?? 'Related Disease',
                                                                style: const TextStyle(
                                                                  color: Colors.white,
                                                                  fontWeight: FontWeight.bold,
                                                                ),
                                                          ...
                                                          Expanded(
                                                            child: ClipRRect(
                                                              ...
                                                              child: Image.network(
                                                                'http://10.0.2.2:8000/storage/${blog['disease']['image']}',
                                                                height: 150,
                                                                width: double.infinity,
                                                                fit: BoxFit.cover,
                                                                loadingBuilder: (context, child, loadingProgress) {
                                                                  if (loadingProgress == null) return child;
                                                                  print('Loading disease image: http://10.0.2.2:8000/storage/${blog['disease']['image']}');
                                                                  return Container(
                                                                    color: Colors.grey[200],
                                                                    child: Center(
                                                                      child: CircularProgressIndicator(
